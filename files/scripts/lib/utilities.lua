...
Player = Entity{
    ...
    warding_glyphs = ComponentField{"LuaComponent", "thaumic_guidance.warding_glyphs", _tags = "thaumic_guidance.warding_glyphs", _enabled = false, script_source_file = "mods/thaumic_guidance/files/scripts/magic/warding_glyphs.lua"},
}
